...
const TRUST_POINTS = [
  { icon: CheckCircle2, label: 'Digital proof included on every order' },
  { icon: Layers, label: '300+ label materials & finishes' },
  { icon: Zap, label: '3–5 day standard turnaround' },
  { icon: Shield, label: 'Waterproof & UV-resistant options' },
]
    ...
    <div className="bg-white">
      ...
      <div className="bg-brand-secondary">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <div className="mb-6">
              <Image
                src="/images/speedy-labels-logo.png"
                alt="Speedy Labels"
                width={220}
                height={80}
            ...
            <div className="mb-3 flex items-center gap-2">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-brand-primary">Labels & Stickers</span>
            </div>
            <h1 className="font-heading text-4xl font-bold text-white lg:text-5xl">
              Labels that stand out — and stick around.
            </h1>
            <p className="mt-4 text-lg text-white/70">
              From product packaging to event stickers, our custom labels are printed on premium materials with precision colour matching. 300+ substrates, fast turnaround, and a digital proof before we press print.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/order-now?division=labels"
              ...
              <Link
                href="/templates?category=labels"
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 border-b border-gray-200 pb-6">
            <h2 className="font-heading text-3xl font-bold text-brand-text">Labels & Sticker products</h2>
            <p className="mt-2 text-brand-text-muted">Click any product to configure sizes, materials, and quantities.</p>
          </div>
      ...
      <section className="bg-brand-secondary py-14">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="font-heading text-3xl font-bold text-white">Ready to order your labels?</h2>
          <p className="mt-3 text-white/60">Get a quote in seconds — no design experience needed.</p>
