...
const TRUST_POINTS = [
  { icon: CheckCircle2, label: 'Custom engraving on demand' },
  { icon: Zap, label: '3–5 day turnaround' },
  { icon: Layers, label: 'Wood, acrylic, metal & more' },
  { icon: Star, label: 'Ideal for corporate gifting' },
]
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <div className="mb-3 flex items-center gap-2">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-brand-primary">Speedy Laser</span>
            </div>
            <h1 className="font-heading text-4xl font-bold text-white lg:text-5xl">
              Precision laser engraving & cutting.
            </h1>
            <p className="mt-4 text-lg text-white/70">
              From personalised gifts to professional corporate signage — our laser division delivers fine detail on wood, acrylic, metal, and more. Every piece is cut or engraved to your exact specification.
            </p>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 border-b border-gray-200 pb-6">
            <h2 className="font-heading text-3xl font-bold text-brand-text">Laser products</h2>
            <p className="mt-2 text-brand-text-muted">Browse our laser engraving and cutting range.</p>
          </div>
